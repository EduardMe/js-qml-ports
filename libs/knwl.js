...
function Knwl(language) {
    ...
    this.register('dates', Dates);
    this.register('times', Times);
    this.register('emails', Emails);
    this.register('links', Links);
    this.register('phones', Phones);
    this.register('places', Places);
}
